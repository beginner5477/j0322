...
public class SungjukService {
	...
	public void setSungjukUpdate() {
		...
		while(run)
		{
			System.out.println("수정항목선택: 1.성명 2.국어 3.영어 4.수학 0.종료 =>");
			choice = sc.nextInt();
		...
		if(res != 0) System.out.println("성적 수정이 완료되었습니다.");
		else System.out.println("성적 수정 실패하였습니다.");
	}
	...
	private void sungjukBasicSearch() {
		...
		else System.out.println("검색하신 "+name+"으로된 자료는 없습니다.");
	}
	...
	public void setSungjukDelete() {
		...
		if(vo.getName() != null)
		{
			...
			String an = sc.next();
			if(an.toUpperCase().equals("Y")) res = dao.setSungjukDelete(vo.getName());
			if(res != 0) System.out.println("삭제 처리가 완료되었습니다.");
